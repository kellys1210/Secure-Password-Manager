    ...
    <div className="min-h-screen bg-gray-100 flex justify-center p-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          A simple, secure, zero-knowledge password vault designed to help you manage all of your passwords.
        </p>
      </div>
      ...
      <div className="text-center mt-6">
        <button
          type="button"
          onClick={() => navigate("/")}
          className="w-75 bg-brandnavy text-white py-2 rounded-lg font-semibold 
          hover:bg-opacity-90 disabled:opacity-60"
          > 
          Login
        </button>
      </div>
