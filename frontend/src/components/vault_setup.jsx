...
import { createOrUpdatePassword, 
         getAllPasswords, 
         deletePassword } from "../utils/vault";
...
export default function VaultSetup () {
    ...
    const saveEdit = async () => {
      try {
        ...
        if ( !editValues.application.trim() ||
             !editValues.username.trim() ||
    ...
    const sortEntries = useMemo(() => {
      return entries
        .filter((e) =>
          e.application.toLowerCase().includes(search.toLowerCase())
        )
          ...
          <label className="block text-brandnavy font-semibold mb-1">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-10 top-2 hover:scale-110 transition-transform"
                title="Generate Secure Password"
              >
                <PlusCircleIcon className="h-5 w-5 text-brandnavy" />
              </button>
                        ...
                        {isEditing ? (
                          ...
                          <>
                            <PencilSquareIcon
                              ...
                              onClick={() => editEntry(entry.id, entry)} />
        ...
        {deleteTarget && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center">
            <div className="bg-white p-6 rounded-xl shadow-xl max-w-sm w-full">
              ...
              <p className="mb-6">
              Delete <strong>{entries.find(e => e.id === deleteTarget)?.application}</strong>?
              </p>
